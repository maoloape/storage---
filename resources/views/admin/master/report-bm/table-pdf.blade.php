...
<table class="static" align="center" rules="all" border="1px">
    <thead>
        <tr>
            ...
            <th style="text-align: center; background-color:#dddddd94;">No. Produk</th>
            <th style="text-align: center; background-color:#dddddd94;">No. Kontrak</th>
        </tr>
    </thead>
    <tbody>
        @php
    ...
    <tr>
        ...
        <td style="text-align: center">{{ $row->no_produk }}</td>
        <td style="text-align: center">{{ $row->no_kontrak }}</td>
    </tr>
    @endforeach
    <tr>
        <td style="text-align: left; padding-left: 6px;" colspan="6">Note :</td>
    </tr>
    </tbody>
</table>
