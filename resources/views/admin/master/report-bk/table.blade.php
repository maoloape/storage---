...
<table class="static" align="center" rules="all" border="1px">
    ...
    @endforeach
    <tr>
        <td style="border: 1px solid black; text-align: left; padding-left: 6px;" colspan="4">Note :</td>
    </tr>
    </tbody>
</table>
...
<thead>
    <tr>
        ...
        <th style="border: 1px solid black; background-color:#dddddd94;">Disetujui</th>
