...
<table class="static" align="center" rules="all" border="1px">
    <thead>
        <tr>
            ...
            <th style="text-align: center; background-color:#dddddd94;">Keterangan</th>
        </tr>
    </thead>
    <tbody>
        @php
    ...
    <tr>
        ...
        <td style="text-align: left; padding-left: 6px;">{{ $row->text }}</td>
    </tr>
    @endforeach
    <tr>
        <td style="text-align: left; padding-left: 6px;" colspan="5">Note :</td>
    </tr>
    </tbody>
</table>
