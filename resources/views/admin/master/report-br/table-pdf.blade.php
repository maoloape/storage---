...
<table>
    <thead>
        <tr>
            ...
            <th style="border: 1px solid black; padding: 8px; font-weight: bold;">Keterangan</th>
        </tr>
    </thead>
    <tbody>
        @php
    ...
    <tr>
        ...
        <td style="border: 1px solid black; padding: 8px;">{{ $row->text }}</td>
    </tr>
    @endforeach
    <tr>
        <td style="border: 1px solid black; padding: 8px;" colspan="5">Note :</td>
    </tr>
    </tbody>
</table>
